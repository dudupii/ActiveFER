...
from distil.utils.models.resnet import SupConResNet
from simclr.util import TwoCropTransform, AverageMeter
from simclr.util import adjust_learning_rate, warmup_learning_rate
from simclr.util import set_optimizer, save_model
from simclr.losses import SupConLoss
...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='FER13', help='dataset')
...
def main():
    ...
    # tensorboard
    logger = SummaryWriter(opt.tb_folder, flush_secs=2)
